...
b = readdlm("results/ArXivTh_300train_06lambda_undirected_hybrid_connected_prox.txt")
...
#writedlm("ArXivTh_300train_07lambda_undirected_hybrid_connected_prox_result.txt",results)
